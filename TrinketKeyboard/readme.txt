...
Modified by THE BEST NUNU 14-11-2014:
-added more key descriptors (PRINT_SCREEN button and such)
-modified pressKey function so it presses key once (no need to unpress the button)